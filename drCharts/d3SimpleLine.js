var d3SimpleLine = {
    create: function (elementId, data, {
        x = ([x]) => x, // эту хуету обязательно нужно передавать в формате даты new Date("2001-8-01"), дальше она сама раскидает и отсортирует
        y = ([, y]) => y, // передаем значения
        z = () => 1, // передаем группировку 
